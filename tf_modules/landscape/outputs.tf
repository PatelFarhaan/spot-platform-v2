output "global_dev_apps_lb_arn" {
  value = aws_lb.global_dev_apps_lb.arn
}

output "global_mcp_apps_lb_arn" {
  value = aws_lb.global_mcp_apps_lb.arn
}

output "s3_mcp_spot_plane_bucket_name" {
